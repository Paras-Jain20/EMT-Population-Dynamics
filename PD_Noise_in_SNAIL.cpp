...
typedef boost::array<double, NUMNODES> cell_state; // a cells' variable vector for ODE simulation function
typedef boost::unordered_map<int, boost::array<double, NUMNODES>> population; // stores the values of 4 variables for every cell in the population
...
////////// sorting a fraction of cell's subpopulation when overall population size increase 80% of carrying capacity K
